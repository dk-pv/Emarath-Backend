...
/**
 * The Leads By Source report query (RPT-02.4): paging plus the same filter surface as Leads
 * By Status — period (created or status-changed), team, agent, source, pipeline and the
 * condition builder's payload. `team` accepts repeated params
 ...
 */
export class LeadsBySourceQueryDto {
  @Type(() => Number)
