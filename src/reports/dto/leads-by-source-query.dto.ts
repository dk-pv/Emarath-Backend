...
/**
 * The Leads By Source report query (RPT-02.4): paging plus the period/team filters (AC3) —
 * the same filter surface as Leads By Status. `team` accepts repeated params
